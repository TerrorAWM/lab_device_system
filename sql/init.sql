...
('supervisor', '123456', '王主任', 'supervisor'),
('device', '123456', '赵设备员', 'device'),
('finance', '123456', '张财务', 'finance');

INSERT INTO t_user (username, password, real_name, role, user_type) VALUES 
('张三', '123456', '张三', 'user', 'teacher');
